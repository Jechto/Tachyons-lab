  ...
  return (
    <div className="flex min-h-screen flex-col items-center p-24">
      ...
      <p className="text-lg mb-8 text-gray-600 dark:text-gray-400">
        Development tools for testing converted classes and debugging calculations
      </p>
      ...
      <div className="mt-8 w-full max-w-4xl bg-blue-50 dark:bg-blue-900 p-4 rounded border border-blue-300 dark:border-blue-600">
        ...
        <ul className="text-sm text-blue-700 dark:text-blue-300 space-y-1">
          <li>• <strong>Test Converted Classes:</strong> Runs comprehensive tests on all TypeScript classes</li>
          <li>• <strong>Debug Kitasan Black:</strong> Tests a single card (ID: 30028) for detailed debugging</li>
          <li>• Check browser console for detailed logging during execution</li>
          <li>• Use Chrome DevTools for step-by-step debugging if needed</li>
        </ul>
      </div>
    </div>
  );
